...
namespace AngularBooking.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PricingStrategyItems",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PricingStrategyId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PricingStrategyItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PricingStrategyItems_PricingStrategies_PricingStrategyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Isles = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Showings_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Showings_PricingStrategies_PricingStrategyId",
                        column: x => x.PricingStrategyId,
                        principalTable: "PricingStrategies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgreedPrice = table.Column<float>(nullable: false),
                    AgreedPriceName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingStrategyItems_PricingStrategyId",
                table: "PricingStrategyItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Showings_EventId",
                table: "Showings",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_Showings_PricingStrategyId",
                table: "Showings",
                column: "PricingStrategyId");
